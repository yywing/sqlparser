...
type ClickHouseParserListener interface {
	...
	// EnterClickhouseFile is called when entering the clickhouseFile production.
	EnterClickhouseFile(c *ClickhouseFileContext)
	...
	// EnterInPartitionClause is called when entering the inPartitionClause production.
	EnterInPartitionClause(c *InPartitionClauseContext)
	...
	// EnterRenameEntityClause is called when entering the renameEntityClause production.
	EnterRenameEntityClause(c *RenameEntityClauseContext)
	...
	// EnterDictionaryIdentifier is called when entering the dictionaryIdentifier production.
	EnterDictionaryIdentifier(c *DictionaryIdentifierContext)
	...
	// ExitClickhouseFile is called when exiting the clickhouseFile production.
	ExitClickhouseFile(c *ClickhouseFileContext)
	...
	// ExitInPartitionClause is called when exiting the inPartitionClause production.
	ExitInPartitionClause(c *InPartitionClauseContext)
	...
	// ExitRenameEntityClause is called when exiting the renameEntityClause production.
	ExitRenameEntityClause(c *RenameEntityClauseContext)
	...
	// ExitDictionaryIdentifier is called when exiting the dictionaryIdentifier production.
	ExitDictionaryIdentifier(c *DictionaryIdentifierContext)
