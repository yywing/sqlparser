...
SECONDARY_SYMBOL
    : S E C O N D A R Y                                                                   {p.isServerVersionGe80016()}?
    ;                                                                                     // MYSQL
...
STREAM_SYMBOL
    : S T R E A M                                                                         {p.serverVersion >= 80020}?
    ;                                                                                     // MYSQL
...
RETURNING_SYMBOL
    : R E T U R N I N G                                                                   {p.isServerVersionGe80021()}?
    ;                                                                                     // SQL-2016-N
...
TLS_SYMBOL
    : T L S                                                                               {p.isServerVersionGe80021()}?
    ;                                                                                     // MYSQL
...
ZONE_SYMBOL
    : Z O N E                                                                             {p.isServerVersionGe80022()}?
    ;                                                                                     // SQL-2003-N
...
REPLICA_SYMBOL
    : R E P L I C A                                                                       {p.isServerVersionGe80022()}?
    ;

REPLICAS_SYMBOL
    : R E P L I C A S                                                                     {p.isServerVersionGe80022()}?
    ;
...
SOURCE_AUTO_POSITION_SYMBOL
    : S O U R C E '_' A U T O '_' P O S I T I O N                                         {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_BIND_SYMBOL
    : S O U R C E '_' B I N D                                                             {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_COMPRESSION_ALGORITHM_SYMBOL
    : S O U R C E '_' C O M P R E S S I O N '_' A L G O R I T H M                         {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_CONNECT_RETRY_SYMBOL
    : S O U R C E '_' C O N N E C T '_' R E T R Y                                         {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_DELAY_SYMBOL
    : S O U R C E '_' D E L A Y                                                           {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_HEARTBEAT_PERIOD_SYMBOL
    : S O U R C E '_' H E A R T B E A T '_' P E R I O D                                   {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_HOST_SYMBOL
    : S O U R C E '_' H O S T                                                             {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_LOG_FILE_SYMBOL
    : S O U R C E '_' L O G '_' F I L E                                                   {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_LOG_POS_SYMBOL
    : S O U R C E '_' L O G '_' P O S                                                     {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_PASSWORD_SYMBOL
    : S O U R C E '_' P A S S W O R D                                                     {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_PORT_SYMBOL
    : S O U R C E '_' P O R T                                                             {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_PUBLIC_KEY_PATH_SYMBOL
    : S O U R C E '_' P U B L I C '_' K E Y '_' P A T H                                   {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_RETRY_COUNT_SYMBOL
    : S O U R C E '_' R E T R Y '_' C O U N T                                             {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_SSL_SYMBOL
    : S O U R C E '_' S S L                                                               {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_SSL_CA_SYMBOL
    : S O U R C E '_' S S L '_' C A                                                       {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_SSL_CAPATH_SYMBOL
    : S O U R C E '_' S S L '_' C A P A T H                                               {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_SSL_CERT_SYMBOL
    : S O U R C E '_' S S L '_' C E R T                                                   {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_SSL_CIPHER_SYMBOL
    : S O U R C E '_' S S L '_' C I P H E R                                               {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_SSL_CRL_SYMBOL
    : S O U R C E '_' S S L '_' C R L                                                     {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_SSL_CRLPATH_SYMBOL
    : S O U R C E '_' S S L '_' C R L P A T H                                             {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL
...
SOURCE_SSL_VERIFY_SERVER_CERT_SYMBOL
    : S O U R C E '_' S S L '_' V E R I F Y '_' S E R V E R '_' C E R T                   {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_TLS_CIPHERSUITES_SYMBOL
    : S O U R C E '_' T L S '_' C I P H E R S U I T E S                                   {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_TLS_VERSION_SYMBOL
    : S O U R C E '_' T L S '_' V E R S I O N                                             {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_USER_SYMBOL
    : S O U R C E '_' U S E R                                                             {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_ZSTD_COMPRESSION_LEVEL_SYMBOL
    : S O U R C E '_' Z S T D '_' C O M P R E S S I O N '_' L E V E L                     {p.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL
...
BULK_SYMBOL
    : B U L K                                                                             {p.serverVersion >= 80032}?
    ;                                                                                     // MYSQL

URL_SYMBOL
    : U R L                                                                               {p.serverVersion >= 80032}?
    ;                                                                                     // MYSQL
...
DOLLAR_QUOTED_STRING_TEXT
   : '$' DOLLAR_QUOTE_TAG_CHAR* '$' .*? '$' DOLLAR_QUOTE_TAG_CHAR* '$' {p.doDollarQuotedStringText()}?;
